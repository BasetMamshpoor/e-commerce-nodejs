...
هرکدام از این دکمه‌ها دقیقاً مثل تایپ‌کردن یک سوال معمولی رفتار می‌کند —
از همان لایه ۱ (با همان حافظه‌ی مکالمه) رد می‌شود. «☎️ تماس با پشتیبانی»
مستقیم مکالمه را به اپراتور ارجاع می‌دهد، بدون این‌که منتظر AI بماند.
تنظیم/تغییر متن دکمه‌ها: `src/telegram/telegram-menu.ts`.
